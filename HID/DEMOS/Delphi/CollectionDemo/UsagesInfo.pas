...
procedure UsageAndUsagePageText2(UsagePage, Usage: TUsage; var UsagePageText, UsageText: string);  // 有部份 case 项在 UsageAndUsagePageText 中放不下，编译出错，所以分为两个
...
begin
  ...
  if (UsagePageText='') and (UsageText='') then
    UsageAndUsagePageText2(UsagePage, usage, UsagePageText, UsageText);
...
procedure UsageAndUsagePageText2(UsagePage, Usage: TUsage; var UsagePageText, UsageText: string);
begin
  UsagePageText := '';
  UsageText := '';
  case UsagePage of
